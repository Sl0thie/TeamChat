namespace TeamChat.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public async Task SendHello(string username)
        {
            ...
            await Clients.Caller.SendAsync("ReceiveMessage", "Admin", "<span class=\"sg\">[" + DateTime.Now.ToString("h:mm:ss") + "]</span><span class=\"sg\">[Server]</span><span class=\"sb\">  Hi" + username + ", welcome to TeamChat.</span>");
            await Clients.Caller.SendAsync("ReceiveMessage", "Admin", "<span class=\"sg\">[" + DateTime.Now.ToString("h:mm:ss") + "]</span><span class=\"sg\">[Server]</span><span class=\"sb\">  There are currently " + UserHandler.ConnectedIds.Count + " connections to this server.</span>");
        }
    }
